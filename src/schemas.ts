export const schemas: Record<string, object> = {
  ...
  'task.schema.json': { $schema: 'https://json-schema.org/draft/2020-12/schema', type: 'object', required: ['apiVersion', 'kind', 'metadata', 'scenarios', 'capabilities', 'safety', 'evidence'] },
