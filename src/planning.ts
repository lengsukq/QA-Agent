...
import { approvalIsCurrent, confirmationMode, executionIntent, MERGED_TEST_CONFIRMATION_ZH, PLAN_REQUIREMENTS_CONFIRMATION_ZH, planReviewIsCurrent, requiresTestPlanApproval, testPlanHash } from './approval.ts';
